...
4) type: git push
5) The result of this will show "fatal:..." and another line that starts with "git push....".  Copy the "git push..." line into your terminal and enter.  This sets the connection between your repo in your terminal and the repo on github.com.
6) OPTIONAL - type: git checkout [yourname]-workshop --> This switches you into your branch so that you're working from your personal branch.
...
9) Make sure that the first button says "base: master" and the second button says "compare: [your branch]"
